...
export default class QuestDAO {
    ...
    mapQuest(quest) {
        return {
            ...
            dataLimite: quest.dataLimite,
            dificuldade: quest.dificuldade,
            // Relacionamento com Turma
            turma: quest.turma || quest.turmaId
        };
    }
    ...
    toPlain(quest) {
        ...
        return {
            ...
            // Envia o ID da turma para o backend fazer a ligação
            turmaId: turma?.getId?.() || turma 
        };
    }
