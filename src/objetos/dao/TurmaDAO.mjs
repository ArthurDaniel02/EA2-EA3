...
export default class TurmaDAO {
    ...
    async salvar(turma) {
        try {
            ...
            // Nota: Turma usa 'codigo' como ID, mas se for autogerado, deletamos
            delete obj.id; 
    ...
    mapTurma(turma) {
        // Mapeia o objeto vindo do banco
        return {
            id: turma.id || turma._id,
            nome: turma.nome,
            codigo: turma.codigo,
            semestre: turma.semestre,
            salaVirtual: turma.salaVirtual,
            ativa: turma.ativa,
            // Se o backend mandar o objeto Professor completo, mapeamos
            professor: turma.professor || turma.professorId
        };
    }
    ...
    toPlain(turma) {
        ...
        // Pega o objeto professor de dentro da turma
        ...
        return {
            ...
            // Aqui enviamos o ID do professor para criar o relacionamento no banco
            professorId: prof?.getId?.() || prof 
        };
    }
